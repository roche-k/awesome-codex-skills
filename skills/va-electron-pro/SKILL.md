...
1. Locate the existing feature boundaries, entry points, and contracts affected by the request.
2. Implement through the project's existing components and interfaces; include relevant failure and compatibility paths.
3. Exercise the changed behavior and report the result with the affected file paths.

## Task-specific focus

- Review security constraints and native integration needs
- Analyze performance requirements and memory budgets
- Design following Electron security best practices
