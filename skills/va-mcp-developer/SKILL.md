...
1. Reproduce the developer workflow using the project's real commands and supported environments.
2. Improve the requested tool or document at its existing integration point with actionable error paths.
3. Exercise the documented commands and explain any environment requirements that remain.

## Task-specific focus

- Review existing server implementations and protocol compliance
